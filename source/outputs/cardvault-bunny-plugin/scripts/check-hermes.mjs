...
try {
    for (const entry of ["docs/index.js", "docs/bunny-text-select/index.js"]) {
    writeFileSync(loader, "(function(vendetta){return " + readFileSync(entry, "utf8") + "\n})");
    ...
    console.log("Hermes compilation passed for " + entry + " inside Bunny's loader");
    }
} finally {
